...
@section('content')
    <div class="w-75 d-block mx-auto my-5">
        <form method="POST" action="{{ route('sign_up.add') }}">
            {{-- token : kunci yang diminta sever biar formulir bisa mengirimm data ke server/ke controller --}}
            @csrf
            ...
            <div class="row mb-4">
                ...
                <div class="col">
                    <div data-mdb-input-init class="form-outline">
                        {{-- setiap input harus punya name : identitas data agar bisa diambil di controllernya --}}
