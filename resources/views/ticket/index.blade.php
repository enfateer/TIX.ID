        ...
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                        type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Tiket non
                        Aktif</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                        ...
                        @foreach ($ticketActive as $ticket)
                            <div class="w-25 me-4 p-4" style="border: 1px solid #eaeaea; border-radius: 5px;">
                                ...
                                <div class="ticket-body text-start">
                                    ...
                                    <a href="{{ route('tickets.export_pdf', $ticket->id) }}" class="btn btn-secondary mt-3">
                                        Unduh .Pdf</a>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                    <h5 class="my-4">Data tiket Non Aktif, {{ Auth::user()->name }}</h5>
                     <div class="d-flex flex-wrap">
                        @foreach ($ticketNonActive as $ticket)
                            <div class="w-25 me-4 p-4" style="border: 1px solid #eaeaea; border-radius: 5px;">
                                ...
                                <div class="ticket-body text-start">
                                    ...
                                    <div class="ticket-details">
                                        <small>Tanggal :
                                        </small> <b class="text-danger">{{ \Carbon\Carbon::parse($ticket['ticketPayment']['booked_date'])->format('d, F, Y') }}</b>
                                        <br>
                                        <small>Waktu : </small>{{ \Carbon\Carbon::parse($ticket['hours'])->format('H:i') }} <br>
                                        <small>Kursi : </small>{{ implode(', ', $ticket['rows_of_seats']) }} <br>
                                        @php
